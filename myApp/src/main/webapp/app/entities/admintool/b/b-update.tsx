...
import { IA } from 'app/shared/model/admintool/a.model';
import { getEntities as getAs } from 'app/entities/admintool/a/a.reducer';
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="myApp.admintoolB.home.createOrEditLabel">
            <Translate contentKey="myApp.admintoolB.home.createOrEditLabel">Create or edit a B</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : bEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label for="b-a">
                  <Translate contentKey="myApp.admintoolB.a">A</Translate>
                </Label>
