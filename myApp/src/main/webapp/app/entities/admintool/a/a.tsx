...
export const A = (props: IAProps) => {
  ...
  return (
    <div>
      <h2 id="a-heading">
        <Translate contentKey="myApp.admintoolA.home.title">AS</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="myApp.admintoolA.home.createLabel">Create new A</Translate>
        </Link>
      </h2>
        ...
        {aList && aList.length > 0 ? (
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="myApp.admintoolA.home.notFound">No AS found</Translate>
            </div>
          )
        )}
      </div>
