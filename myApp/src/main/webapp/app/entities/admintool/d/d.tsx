...
import { ID } from 'app/shared/model/admintool/d.model';
...
export const D = (props: IDProps) => {
  ...
  return (
    <div>
      <h2 id="d-heading">
        <Translate contentKey="myApp.admintoolD.home.title">DS</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="myApp.admintoolD.home.createLabel">Create new D</Translate>
        </Link>
      </h2>
        ...
        {dList && dList.length > 0 ? (
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="myApp.admintoolD.home.notFound">No DS found</Translate>
            </div>
          )
        )}
      </div>
