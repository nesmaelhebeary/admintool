package com.hypercell.admintool.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("admintool");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("admintool");
        ...
        config.getMapConfigs().put("com.hypercell.admintool.domain.*", initializeDomainMapConfig(jHipsterProperties));
